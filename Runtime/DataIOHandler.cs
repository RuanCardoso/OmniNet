...
namespace Omni.Core
{
	...
	public sealed class DataIOHandler
	{
		...
		/// <summary>
		/// Writes a n-bit array of bytes to the output stream.
		/// </summary>
		/// <param name="nBits">The n-bit array of bytes to write.</param>
		internal void WriteNBits(byte[] nBits)
		{
			Write7BitEncodedInt(nBits.Length);
		...
		/// </summary>
		/// <returns>An array of bytes representing the n bits of data.</returns>
		internal byte[] ReadNBits()
		{
