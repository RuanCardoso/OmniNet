...
namespace Omni.Core
{
	//internal sealed class UdpServer : OmniTransporter
	//{
	...
	//	protected override UdpClient GetClient(UdpEndPoint remoteEndPoint) => GetClient((ushort)remoteEndPoint.GetPort());
