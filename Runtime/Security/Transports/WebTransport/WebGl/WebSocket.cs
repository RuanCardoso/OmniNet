...
namespace NativeWebSocket
{
  ...
  public class WebSocket : IWebSocket {
    ...
    public Task Send (byte[] data) {
	 ...
	 public Task Send (byte[] data, int offset, int count) {
	...
	public class WebSocket : IWebSocket
	{
		...
		public Task Send(byte[] bytes, int offset, int count)
		{
			// return m_Socket.SendAsync(buffer, WebSocketMessageType.Binary, true, CancellationToken.None);
			return SendMessage(sendBytesQueue, WebSocketMessageType.Binary, new ArraySegment<byte>(bytes, offset, count));
		}
