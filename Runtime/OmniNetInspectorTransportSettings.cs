...
namespace Omni.Core
{
	...
	public partial class OmniNetwork : RealtimeTickBasedSystem
	{
		...
		[OnValueChanged("OnTransportOptionChanged")]
		...
		[SerializeField][DisableIf("transportOption", TransportOption.LiteNetTransport)][MinValue(1)] private int m_IOPS = 1;
		...
		[InfoBox("Experimental: Use direct socket calls to drastically increase speed and reduce GC pressure. Only for Windows/Linux.")]
