...
namespace Omni.Editor
{
	...
	public class InfoBoxDecoratorDrawer : PropertyDrawerBase
	{
		...
		/// </summary>
		InfoBoxAttribute helpAttribute { get { return (InfoBoxAttribute)attribute; } }
		...
		protected override float GetPropertyHeight_Internal(SerializedProperty prop, GUIContent label)
		{
			// We store the original property height for later use...
			baseHeight = base.GetPropertyHeight_Internal(prop, label);
		...
		protected override void OnGUI_Internal(Rect position, SerializedProperty prop, GUIContent label)
		{
			...
			DrawInfoBox(helpPos, helpAttribute.Text, helpAttribute.Type);
